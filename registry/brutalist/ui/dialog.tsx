...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-5 -mb-5 flex flex-col-reverse gap-3 border-t-[var(--brut-border)] border-border bg-muted p-5 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
